...
![](HighSchoolGrad_files/figure-gfm/BMI_hist-1.png)<!-- --> <br>
...
![](HighSchoolGrad_files/figure-gfm/bmi_genhlth-1.png)<!-- --> <br>
...
![](HighSchoolGrad_files/figure-gfm/stack1-1.png)<!-- --> Another
...
![](HighSchoolGrad_files/figure-gfm/stack2-1.png)<!-- --> Interesting
...
```
    ...
    ## 1 0.001613528 0.4236082 0.003398364
    ## 2 0.003356138 0.4241276 0.003755993
    ## 3 0.004621144 0.4420264 0.020614525
...
```
    ...
    ## 1    1 2.3249725 0.081644113
    ## 2    2 0.8271364 0.063776058
    ## 3    3 0.5275118 0.027883775
    ## 4    4 0.4530029 0.016877553
    ## 5    5 0.4316320 0.010373631
    ## 6    6 0.4201803 0.008596237
...
```
    ...
    ## maximum number of iterations reached 0.001097067 0.001027276
...
```
    ...
    ## Summary of sample sizes: 35141, 35140, 35140, 35141, 35142 
    ## Resampling results:
    ## 
    ##   logLoss  
    ##   0.4587924
...
```
    ...
    ## 1 0.3779266 0.3780743 0.4204835 0.4124162 0.4679264 0.3811459
